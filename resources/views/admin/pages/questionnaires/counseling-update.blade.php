...
@section('content')
    ...
    <div class="mt-5">
        <form action="{{ route('admin.counselings.update', ['id' => $counseling->id])}}" method="POST"
            ...
            <div class="row">
                <div class="col-md-8 mb-4 mt-2">
                    ...
                    <input type="text" name="student_name" id="student_name" value="{{$counseling->student_name}}" class="w-full px-3 py-2 border rounded-lg"
                ...
                <div class="col-md-4 mb-4 mt-2">
                    ...
                    <input type="date" name="date" id="date" value="{{$counseling->date}}" class="w-full px-3 py-2 border rounded-lg">
            ...
            <div class="row">
                <div class="col-md-4 mb-4 mt-2">
                    ...
                    <input type="text" name="course_year" value="{{$counseling->course_year}}" id="course_year" class="w-full px-3 py-2 border rounded-lg"
                ...
                <div class="col-md-4 mb-4 mt-2">
                    ...
                    <input type="text" name="department" value="{{$counseling->department}}" id="department" class="w-full px-3 py-2 border rounded-lg"
                ...
                <div class="col-md-4 mb-4 mt-2">
                    ...
                    <input type="number" name="contact_num" value="{{$counseling->contact_num}}" id="contact_num" class="w-full px-3 py-2 border rounded-lg"
            ...
            <div class="col-md-12 mb-4 mt-2">
                ...
                <input type="checkbox" id="visit_nature_walkin" name="visit_nature" value="Walk in" {{ $counseling->visit_nature === 'Walk in' ? 'checked' : '' }}> Walk in
                <input type="checkbox" id="visit_nature_referral" name="visit_nature" value="Referral" {{ $counseling->visit_nature === 'Referral' ? 'checked' : '' }}> Referral
            </div>


            <div class="mb-4">
                <label for="concern" class="block text-gray-700 font-semibold mb-2">Problem(s)/Concern(s)</label>
                <textarea name="concern" id="concern" class="w-full px-3 py-2 border rounded-lg" placeholder="Enter concern">{{$counseling->concern}}"</textarea>
            ...
            <div class="mb-4">
                ...
                <textarea name="action_taken" id="action_taken" class="w-full px-3 py-2 border rounded-lg" placeholder="Enter Action Taken">{{$counseling->action_taken}}"</textarea>
            ...
            <div class="row">
                <div class="col-md-4 mb-4 mt-2">
                    ...
                    <input type="date" name="followup_dates" value="{{$counseling->followup_dates}}" id="followup_dates" class="w-full px-3 py-2 border rounded-lg">
                ...
                <div class="col-md-4 mb-4 mt-2">
                    ...
                    <input type="number" name="session_ended" id="session_ended" value="{{$counseling->session_ended}}" class="w-full px-3 py-2 border rounded-lg"
                        placeholder="Enter number">
            ...
            <div class="row">
                <div class="col-md-6 mb-4 mt-2">
                    ...
                    <input type="text" name="counselee" id="counselee" value="{{$counseling->counselee}}" class="w-full px-3 py-2 border rounded-lg"
                ...
                <div class="col-md-6 mb-4 mt-2">
                    ...
                    <input type="text" name="counselor" id="counselor" value="{{$counseling->counselor}}" class="w-full px-3 py-2 border rounded-lg" placeholder="Enter Counselor">
